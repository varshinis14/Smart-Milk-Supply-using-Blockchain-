<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddMilkBooth.aspx.cs" Inherits="SmartMilkSupply.AddMilkBooth" %>
                ...
                <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                   ...
                   <div class="form-body">
                        <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ddlArea"
                                        ForeColor="#FF3300" ValidationGroup="A" InitialValue="--Select--" runat="server"
                                        ErrorMessage="Please Select Area"></asp:RequiredFieldValidator>
                                </div>
